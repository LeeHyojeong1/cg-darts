...
def main():
  ...
  utils.load(model, args.model_path, device)
  ...
  test_data = dset.CIFAR10(root=args.data, train=False, download=args.download, transform=test_transform)
  ...
  test_acc, test_obj = infer(test_queue, model, criterion, device)
  logging.info('test_acc %f', test_acc)


def infer(test_queue, model, criterion, device):
